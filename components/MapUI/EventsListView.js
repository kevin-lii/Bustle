...
import { View, Text, ScrollView, SafeAreaView, Dimensions, TouchableWithoutFeedback, Image } from "react-native";
          ...
          >
            {eventList.map((event, index) => (
              <View
                ...
                key={index}
              >
                <TouchableWithoutFeedback onPress={() => this.props.navigateTo({ event, events: null })}>
                  <View style={styles.textContent}>
                    <Image style={{ height: "75%" }} source={{ uri: event.photoURL }}></Image>
